...
public class StartScreen extends AppCompatActivity
{
    ...
    private void initializeViews()
    {
        ...
        guestBtn = findViewById(R.id.btn_start_skip);
    }//end initializeViews()

    private void setButtonsListner()
    {
    ...
    private void googleSignIn() {
        ...
        googleSignInClient = GoogleSignIn.getClient(StartScreen.this, googleSignInOptions);
        ...
        if (firebaseUser != null) {
            ...
            startActivity(new Intent(StartScreen.this, MainActivity.class).setFlags(Intent.FLAG_ACTIVITY_NEW_TASK));
        }
    }
                        ...
                        firebaseAuth.signInWithCredential(authCredential).addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                            ...
                            public void onComplete(@NonNull Task<AuthResult> task) {
                                if (task.isSuccessful()) {
                                    ...
                                    Toast.makeText(StartScreen.this, "Firebase authentication Failed", Toast.LENGTH_SHORT).show();
                                }
                            }
                        });
                    }
