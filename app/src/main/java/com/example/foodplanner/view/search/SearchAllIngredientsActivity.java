...
public class SearchAllIngredientsActivity extends AppCompatActivity implements AllIngredientsActivityInterface
{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_search_all_ingredients);
        ...
        closeScreen=findViewById(R.id.iv_close_search_by_ingredients);
        closeScreen.setOnClickListener(v -> finish());

        getIngredients();
        searchView=findViewById(R.id.sv_search_ingredients);
